...
Este archivo debe leerse antes de hacer cualquier cambio en este repositorio.

## Reglas obligatorias
- Leer este archivo antes de modificar código, estructura o documentación.
- Mantener la arquitectura propuesta en la consigna: diseño multiproceso, comunicación vía multiprocessing y lectura directa de /proc.
- No usar psutil ni librerías que oculten el acceso a /proc.
- Mantener el código claro, documentado y alineado con el TP de Computación II.
- Preferir cambios pequeños y bien justificados.
- Si se agregan nuevas funcionalidades, conservar la estructura de carpetas y los nombres de módulos.
